...
namespace Market.AT
{
    public class Proxy
    {
        ...
        */
        ...
        public List<SMember> GetAllMembers(string sessionID)
        {
            Response<List<SMember>> res = service.GetAllMembers(sessionID);
            if (!res.ErrorOccured)
                return res.Value;
            return null;

        }
        public List<SMember> GetActiveMembers(string sessionID)
        {
            Response<List<SMember>> res = service.GetActiveMembers(sessionID);
            if (!res.ErrorOccured)
                return res.Value;
            return null;
        }
