    ...
    public class Member : User
    {
        ...
        private void AddApointee(int shopId, Member appointee)
        {
            ...
            lock (MarketContext.MarketContextLock)
            {
                ...
                AppointmentDTO appointmentDTO = context.Appointments.Find(appointee.Id, shopId);
                MemberDTO memberDTO = context.Members.Find(appointee.Id);
                appointmentDTO.Appointees.Add(memberDTO);
                context.SaveChanges();
            }
            //=================================================
        }
        private void RemoveApointee(int shopId, Member appointee)
        {
            ...
            lock (MarketContext.MarketContextLock)
            {
                ...
                AppointmentDTO appointmentDTO = context.Appointments.Find(appointee.Id, shopId);
                MemberDTO memberDTO = context.Members.Find(appointee.Id);
                appointmentDTO.Appointees.Remove(memberDTO);
                context.SaveChanges();
            }
            //=================================================
        }
